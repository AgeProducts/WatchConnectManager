...
//        if segueIdentifier == "toSecond"{
//            let context:[String:Any] = ["Title":"from First" as Any]
...
//    }
    ...
    @IBAction func sendButton() {
        if WatchConnectShared.zUpdateApplicationContext("zCommand$$", addInfo: ["I am watchOS.", "AplContext", Date()]) == false {
